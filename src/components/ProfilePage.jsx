      ...
      >
        ...
        {editing ? (
          <>
            <Typography
              variant="h4"
              sx={{ fontWeight: 600, color: "#000", marginBottom: 3 }}
            >
              Edit Profile
            </Typography>
            ...
            <TextField
              ...
              helperText={
                profile.latitude
                  ? "Edit if needed"
                  : 'Click "Detect My Location" or enter manually (e.g., 37.7749)'
              }
            />
            <TextField
              fullWidth
              ...
              helperText={
                profile.longitude
                  ? "Edit if needed"
                  : 'Click "Detect My Location" or enter manually (e.g., -122.4194)'
              }
            />
            <TextField
              fullWidth
            ...
            <Box sx={{ marginBottom: 3 }}>
              ...
              <Autocomplete
                ...
                onChange={(_, newValue) =>
                  updateSkills("skillsOffered", newValue)
                }
            ...
            <Box sx={{ marginBottom: 3 }}>
              ...
              <Autocomplete
                ...
                onChange={(_, newValue) =>
                  updateSkills("skillsNeeded", newValue)
                }
                disableCloseOnSelect
                getOptionLabel={(option) => option}
                renderOption={(props, option, { selected }) => (
          ...
          <>
            <Box sx={{ textAlign: "center", marginBottom: 3 }}>
              ...
              <Typography
                variant="h4"
                sx={{ fontWeight: 600, color: "#000", marginBottom: 1 }}
              >
            ...
            <Box sx={{ marginBottom: 2 }}>
              ...
              {profile.skillsOffered.map((item) => (
                <Typography key={item.skill} variant="body1">{`${item.skill}: ${
                  offerDescriptions[item.skill]
                }`}</Typography>
              ))}
            </Box>
            <Box sx={{ marginBottom: 2 }}>
